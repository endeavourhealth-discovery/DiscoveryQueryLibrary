drop procedure if exists getMedicationsNameDate;

DELIMITER //
CREATE PROCEDURE getMedicationsNameDate (
...
call getMedications( snomedIds, filterType );
...
-- Update
SET @sql = CONCAT('UPDATE ', datasetTable, ' d join filteredMedications f ON d.patient_id = f.patient_id SET ',
