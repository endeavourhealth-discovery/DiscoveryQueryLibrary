...
DROP PROCEDURE IF EXISTS populateEastLondonCCGCodesBP1;

DELIMITER //

CREATE PROCEDURE populateEastLondonCCGCodesBP1()
BEGIN

DROP TABLE IF EXISTS bp1_eastlondonccg_codes;

CREATE TABLE bp1_eastlondonccg_codes (
name         VARCHAR(100),
local_id     VARCHAR(100),
parent       VARCHAR(100)
);

ALTER TABLE bp1_eastlondonccg_codes ADD INDEX bp1_local_idx(local_id);

INSERT INTO bp1_eastlondonccg_codes (name, local_id, parent)
VALUES
