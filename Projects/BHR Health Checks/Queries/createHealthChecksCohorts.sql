...
DROP TABLE IF EXISTS tmp_health_checks_observation_1;
CREATE TABLE tmp_health_checks_observation_1 AS 
SELECT DISTINCT  o.patient_id,
                 pt.nhs_number,
                 pt.patient_gender_id,
                 pt.ethnic_code,
...
FROM enterprise_pi.observation o
     JOIN enterprise_pi.patient pt ON pt.id = o.patient_id 
     JOIN enterprise_pi.organization org ON org.id = o.organization_id
WHERE DATEDIFF(o.clinical_effective_date, pt.date_of_birth) / 365.25 BETWEEN 40 AND 75
AND org.ods_code IN (SELECT ods_code FROM hc_organisations);


ALTER TABLE tmp_health_checks_observation_1 ADD INDEX pat_idx (patient_id);
ALTER TABLE tmp_health_checks_observation_1 ADD INDEX org_code_idx (original_code);


DROP TEMPORARY TABLE IF EXISTS health_checks_observation_tmp1;
CREATE TEMPORARY TABLE health_checks_observation_tmp1 AS    
SELECT DISTINCT  c.patient_id,
                 ...
                 c.original_term,
                 c.result_value,
                 c.result_value_units
FROM tmp_health_checks_observation_1 c JOIN rf2.code_set_codes cs ON CONCAT('CTV3_',cs.ctv3_concept_id) = c.original_code AND BINARY CONCAT('CTV3_',cs.ctv3_concept_id) = c.original_code 
WHERE cs.code_set_id BETWEEN 8 AND 67;

DROP TEMPORARY TABLE IF EXISTS health_checks_observation_tmp2;
CREATE TEMPORARY TABLE health_checks_observation_tmp2 AS   
SELECT DISTINCT  c.patient_id,
                 c.nhs_number,
                 c.patient_gender_id,
                 c.ethnic_code,
                 ...
                 c.result_value,
                 c.result_value_units
FROM tmp_health_checks_observation_1 c JOIN rf2.code_set_codes cs ON cs.read2_concept_id = c.original_code AND BINARY cs.read2_concept_id = c.original_code 
WHERE cs.code_set_id BETWEEN 8 AND 67;

DROP TEMPORARY TABLE IF EXISTS health_checks_observation_tmp3;
CREATE TEMPORARY TABLE health_checks_observation_tmp3 AS   
SELECT DISTINCT  c.patient_id,
                 c.nhs_number,
                 c.patient_gender_id,
                 c.ethnic_code,
                 ...
                 c.result_value,
                 c.result_value_units
FROM tmp_health_checks_observation_1 c JOIN rf2.code_set_codes cs ON cs.ctv3_concept_id = c.original_code AND BINARY cs.ctv3_concept_id = c.original_code 
WHERE cs.code_set_id IN (6,7);

DROP TEMPORARY TABLE IF EXISTS health_checks_observation_tmp4;
CREATE TEMPORARY TABLE health_checks_observation_tmp4 AS  
SELECT DISTINCT  c.patient_id,
                 c.nhs_number,
                 c.patient_gender_id,
                 c.ethnic_code,
                 ...
                 c.result_value_units
FROM tmp_health_checks_observation_1 c JOIN rf2.code_set_codes cs ON CONCAT('CTV3_',cs.ctv3_concept_id) = c.original_code AND BINARY CONCAT('CTV3_',cs.ctv3_concept_id) = c.original_code 
WHERE cs.code_set_id = 0  -- CVD 10yr 
AND c.result_value IS NOT NULL;

DROP TEMPORARY TABLE IF EXISTS health_checks_observation_tmp5;
CREATE TEMPORARY TABLE health_checks_observation_tmp5 AS  
SELECT DISTINCT  c.patient_id,
                 c.nhs_number,
                 c.patient_gender_id,
                 c.ethnic_code,
...
SELECT           c.patient_id,
                 ...
                 c.result_value,
                 c.result_value_units
FROM health_checks_observation_tmp1 c 
UNION  
SELECT           c.patient_id,
                 c.nhs_number,
                 c.patient_gender_id,
                 ...
                 c.result_value,
                 c.result_value_units
FROM health_checks_observation_tmp2 c 
UNION
SELECT           c.patient_id,
                 c.nhs_number,
                 c.patient_gender_id,
                 ...
                 c.result_value,
                 c.result_value_units
FROM health_checks_observation_tmp3 c 
UNION
SELECT           c.patient_id,
                 c.nhs_number,
                 c.patient_gender_id,
                 ...
                 c.result_value,
                 c.result_value_units
FROM health_checks_observation_tmp4 c 
UNION 
SELECT           c.patient_id,
                 c.nhs_number,
                 c.patient_gender_id,
                 ...
                 c.result_value,
                 c.result_value_units
FROM health_checks_observation_tmp5 c; 

ALTER TABLE tmp_health_checks_observation
ADD INDEX patient_idx (patient_id ASC, original_code ASC, clinical_effective_date ASC);
...
FROM tmp_health_checks_observation o
     ...
     JOIN rf2.code_set_codes c ON c.ctv3_concept_id = o.original_code AND BINARY c.ctv3_concept_id = o.original_code  -- ctv3 
...
FROM tmp_health_checks_observation o
     JOIN tmp_health_checks_cohort_eligible pt ON pt.id = o.patient_id
     JOIN rf2.code_set_codes c ON CONCAT('CTV3_',c.ctv3_concept_id) = o.original_code  AND BINARY CONCAT('CTV3_',c.ctv3_concept_id) = o.original_code  -- cvt3
...
FROM tmp_health_checks_observation o
     JOIN tmp_health_checks_cohort_eligible pt ON pt.id = o.patient_id
     JOIN rf2.code_set_codes c ON c.read2_concept_id = o.original_code AND BINARY c.read2_concept_id = o.original_code  -- read2
