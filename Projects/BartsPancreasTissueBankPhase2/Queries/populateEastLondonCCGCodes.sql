...
DROP PROCEDURE IF EXISTS populateEastLondonCCGCodesBP2;

DELIMITER //

CREATE PROCEDURE populateEastLondonCCGCodesBP2()
BEGIN

DROP TABLE IF EXISTS bp2_eastlondonccg_codes;

CREATE TABLE bp2_eastlondonccg_codes (
name         VARCHAR(100),
local_id     VARCHAR(100),
parent       VARCHAR(100)
);

INSERT INTO bp2_eastlondonccg_codes (name, local_id, parent)
VALUES
