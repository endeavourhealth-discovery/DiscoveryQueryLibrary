...
drop procedure if exists CAB9_generate_test_output_files;
DELIMITER //
create procedure CAB9_generate_test_output_files()
BEGIN

	drop table if exists F50_CAB_TEST_Person_Level_Data;
	create table F50_CAB_TEST_Person_Level_Data as
	select a.person_id
	,	a.matched_with as matched_person_id
    -- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    -- %% Hash person_id using project and variable specific hash key in lookup table
    -- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	,	sha2(concat(cast(a.person_id as char(32)),(select key_value from project_keys where project_name = 'Cabergoline' and variable_name = 'person_id')),256) as unique_person_id
	,	case
	...
	create table F50_CAB_TEST_Cabergoline_Prescriptions as
	...
	create table F50_CAB_TEST_Serum_Prolactin as
	...
	-- New table to capture additional codes missed in initial request (applicant driven)
    	...
    	drop table if exists F50_CAB_TEST_Acromegaly_Codes;
	create table F50_CAB_TEST_Acromegaly_Codes as
	
	select a.person_id
	,	a.organization_ods_code
	,	a.unique_person_id
	,	b.original_term
	,	b.snomed_concept_id
	...
	-- select * from F50_CAB_TEST_Acromegaly_Codes;
